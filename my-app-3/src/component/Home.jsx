    ...
    <div id='backgroundd'>
        <div id="body_content">
            <div>
                <hr class = "line"></hr>
                <div id="profile_pic">
					<img className='h-img' src={require("../styles/pictures/Amir.jpeg")} alt="" />
                    {/* profile Image */}
        ...
        <div>
                ...
                <div id="profile_pic">
                    {/* profile Image */}
					<img className='h-img' src={require("../styles/pictures/gulnara.jpg")} alt="" />
                    {/* <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTWyr-guOND_DzAmtWfqj-HbF-2wK7g0Z2zOA&usqp=CAU cente" alt="Trulli" class="center" /> */}
                    {/* Name under the profile pic */}
		...
		<div>
                <hr class = "line"></hr>
                <div id="profile_pic">
				<img className='h-img' src={require("../styles/pictures/Murad.jpeg")} alt="" />
                    {/* profile Image */}
                    {/* <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTWyr-guOND_DzAmtWfqj-HbF-2wK7g0Z2zOA&usqp=CAU cente" alt="Trulli" class="center" /> */}
                    {/* Name under the profile pic */}
                    <h3 id="user_name">Murad Ibrahimli</h3>
                </div>
                <div id="body_text">
                    <p><b>Age</b><span id="bar1"></span>19</p>
                    <p><b>Phone</b><span id="bar2"></span>+994552163369</p>
                    <p><b>Email</b><span id="bar3"></span>mibrahimli14007@ada.edu.az</p>
                    <p><b>Education</b><span id="bar4"></span>Computer Science</p>
                    <br />
                    <div class="container">
                        <div class="box">HTML5/CSS3</div>
                        <div class="box">JavaScript</div>
            ...
            <h2 class="info">About</h2>
            {/* About Information */}
            <p class="info">I am CS student at ADA University. My main interests are Datascience And Artificial Intelligence</p>
            <h2 class="info">Insterests</h2>
            {/* Interests Information */}
            <p class="info">Gaming, Programming.</p>
            <br />
            <hr class = "line"></hr>
            <h2 class="info">My Projects</h2>
            <ul id="projects">
                ...
                <li>
                    <div>
                        {/* Name of the project and the link to github */}
                        <a href="https://kenwoll.github.io/Simple_waether_app/" className="gitlin"><h4 >Weather app</h4></a>
                        {/* desciption */}
                        <p className="sub_info">Enter name of the city manually</p>
                        <p className="sub_info">Enter latitude and longitude manually</p>
                        <p className="sub_info">Enter current geolocation using Geolocation API</p>
